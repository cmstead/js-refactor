...
describe('Wrap In Async', function () {
    var subcontainer;
    var applySetEditSpy;
    ...
    it('should log an error if selection is empty', function () {
        ...
        subcontainer.build('wrapInAsyncFunctionFactory')(vsCodeFake.window.activeTextEditor, function () { })();

        this.verify(prettyJson(info.args));
    });

    it('should wrap selection in an async function', function () {
        var sourceTokens = readSource('./test/fixtures/wrapInWrapper/wrapInWrapper.js');
        var vsCodeFake = vsCodeFakeFactory();
        var applySetEdit = mocker.getMock('editActionsFactory').api.applySetEdit;
